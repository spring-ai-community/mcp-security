...
```groovy
implementation("org.springaicommunity:mcp-server-security:0.1.3")
...
```groovy
implementation("org.springaicommunity:mcp-client-security:0.1.3")
```
...
```groovy
implementation("org.springaicommunity:mcp-authorization-server:0.1.3")
```
