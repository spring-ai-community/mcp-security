 ...
 */
@ConfigurationProperties(prefix = McpOAuth2ClientProperties.CONFIG_PREFIX)
public class McpOAuth2ClientProperties {

	public static final String CONFIG_PREFIX = "spring.ai.mcp.client.authorization";

	public boolean dynamicClientRegistration = false;

	public boolean dynamicClientRegistrationEnabled() {
